// typego_place_graph: geometry-only place graph for room-aware semantic
...
namespace std {
template <>
struct hash<typego_place_graph::CellCoord> {
    size_t operator()(const typego_place_graph::CellCoord& c) const noexcept {
