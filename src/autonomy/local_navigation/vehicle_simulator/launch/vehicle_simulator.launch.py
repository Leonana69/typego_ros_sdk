...
def generate_launch_description():
  ...
  declare_adjustZ = DeclareLaunchArgument('adjustZ', default_value='false', description='')
  ...
  declare_adjustIncl = DeclareLaunchArgument('adjustIncl', default_value='false', description='')
